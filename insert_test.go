	...
	testCases := []struct {
		...
		},
		{
			...
			wantQuery: &Query{
				...
				Args: []any{int64(1), "Guan", int8(18), &sql.NullString{String: "GangGang", Valid: true}},
			},
		},
		{
			...
			wantQuery: &Query{
				SQL: "INSERT INTO `test_model`(`id`,`first_name`,`age`,`last_name`) VALUES(?,?,?,?),(?,?,?,?);",
				Args: []any{int64(1), "Guan", int8(18), &sql.NullString{String: "GangGang", Valid: true},
					int64(2), "Da", int8(19), &sql.NullString{String: "GangGang", Valid: true}},
			},
		},
		{
			// 指定列
			...
			wantQuery: &Query{
				...
				Args: []any{"Guan", &sql.NullString{String: "GangGang", Valid: true}},
			},
		},
		{
			// 指定列
...

		{
			...
			wantQuery: &Query{
				...
				Args: []any{int64(1), "Guan", int8(18), &sql.NullString{String: "GangGang", Valid: true}, "Da"},
			},
		},
		{
